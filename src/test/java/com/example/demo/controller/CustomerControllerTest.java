...
public class CustomerControllerTest {
    ...
    public void testGetAllCustomers() throws Exception {
        ...
        given(customerService.getAllCustomers()).willReturn(
                Arrays.asList(
                        new Customer(1L, "Juan", "Perez", "juan@test.com", "555-1234", "123 Main St", "111-00-1111"),
                        new Customer(2L, "Ana", "Garcia", "ana@test.com", "555-5678", "456 Elm St", "222-00-2222")
                )
        );
        ...
        mockMvc.perform(get("/customers"))
                ...
                // Validamos que el SSN no esté presente en la respuesta
                .andExpect(jsonPath("$[0].ssn").doesNotExist());
    }

    @Test
    public void testGetCustomerDetail_Found() throws Exception {
        Customer mockCustomer = new Customer(10L, "Carlos", "Lopez", "carlos@test.com", "555-9012", "789 Pine St", "333-00-3333");
        ...
        mockMvc.perform(get("/customers/10"))
                ...
                .andExpect(jsonPath("$.ssn").value("333-00-3333"));
    }
